...
function placeXOrO(squareNumber) {
    ...
    // see if it contains the square number clicked.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O'){
            //This function disables clickingfor computer choice.
            disableClick();
    ...
    function computersTurn() {
        ...
        while(!success){
            ...
            if (placeXOrO(pickASquare)) {
                ...
                //This changes our booleen and ends the loop.
                success = true;
            };
        }
    }
...
//drawWinLine function is called to draw line if conditionis is met.
function checkWinConditions() {
    ...
    // This condition checks for tie. If none of the above concitions register
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y2 = coordY2,
        //This variable stores temnprary x axis data we update in our animation loop.
        x = x1,
        //This variable stores temnprary y axis data we update in our animation loop.
        y = y1;   
    ...
    function animateLineDrawing() {
        ...
        //This method starts a new patch.
        c.beginPath();
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y <y2) {y += 10}
            //This condition cancels our animation loop if reach end points.
    ...
    //Thuis line calls our main animation loop.
    animateLineDrawing();
...
function resetGame() {
    ...
    //This resets our array so it is empty and we can startvover.
    selectedSquares = [];
}